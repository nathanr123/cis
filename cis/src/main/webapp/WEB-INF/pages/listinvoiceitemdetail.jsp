  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href = "${contextPath}/listinvoice">List Invoices </a>
        </li>
        <li class="active">List Invoice Item
        </li>
      </ol>
    </section>
...
<script src="resources/dist/js/demo.js"></script>
	...
	<c:if test="${!empty invoiceitemdetaillist}">
			...
			<c:forEach items="${invoiceitemdetaillist}" var="invoiceitemdetailDetail">
				<tr>
				...
				<c:out value="${sno }"/></td>
					...
					<td> <a href="${contextPath}/loadinvoiceitemdetail?invoiceitemdetail=${invoiceitemdetailDetail.product_ID}">Update Invoice Item</a></td>
					<td><a href="${contextPath}/deleteinvoiceitemdetail?invoiceitemdetail=${invoiceitemdetailDetail.product_ID}">Delete Invoice Item</a></td>
				</c:forEach>	
		 ...
		 <td><a href="${contextPath}/newinvoiceitemdetail">Create New Invoice Item</a></td>
</sec:authorize>	
</body>
</html>