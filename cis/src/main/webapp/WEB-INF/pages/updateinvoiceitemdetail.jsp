  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href = "${contextPath}/listinvoiceitemdetail">List Invoices Item</a>
        </li>
        <li class="active">Update Invoices Item
        </li>
      </ol>
    </section>
...
<script src="resources/dist/js/demo.js"></script>
	...
	<div align="center">
		<form:form action="updateinvoiceitemdetail" method="post"
