  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Create New Purchase Item
        </li>
      </ol>
    </section>
...
<script src="resources/dist/js/demo.js"></script>
	...
	<div align="center">
		<form:form action="createnewpurchaseitemdetail" method="post" commandName="purchaseitemdetailForm">
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                 <form:input path="purchasenumber" class="form-control" />
