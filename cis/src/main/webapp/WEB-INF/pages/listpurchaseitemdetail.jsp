...
<title>List Purchase Item</title>
<c:set var="contextPath" value="${pageContext.request.contextPath}" />
  <meta charset="utf-8">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href = "${contextPath}/listpurchase">List POs </a>
        </li>
        <li class="active">List Purchase Item
        </li>
      </ol>
    </section>
...
<script src="resources/dist/js/demo.js"></script>
	...
	<c:if test="${!empty purchaseitemdetaillist}">
			...
			<c:forEach items="${purchaseitemdetaillist}" var="purchaseitemdetailDetail">
				<tr>
				...
				<c:out value="${sno }"/></td>
					...
					<td> <a href="${contextPath}/loadpurchaseitemdetail?purchaseitemdetail=${purchaseitemdetailDetail.product_ID}">Update Purchase Item</a></td>
					<td><a href="${contextPath}/deletepurchaseitemdetail?purchaseitemdetail=${purchaseitemdetailDetail.product_ID}">Delete Purchase Item</a></td>
				</c:forEach>	
		 ...
		 <td><a href="${contextPath}/newpurchaseitemdetail">Create New Purchase Item</a></td>
	</sec:authorize>
</body>
</html>