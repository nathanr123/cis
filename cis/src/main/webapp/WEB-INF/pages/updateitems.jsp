  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href ="${contextPath}/listitems">List Items</a>
        </li>
        <li class="active">Update Item
        </li>
      </ol>
    </section>
...
<script src="resources/dist/js/demo.js"></script>
	...
	<div align="center">
		<form:form action="updateitems" onsubmit="return doADD();" method="post"
			commandName="itemsForm">
			<form:hidden path="product_ID" 
							value="${itemsForm.getProduct_ID()}" />
			<div class="login-box">
 ...
 <form:input id="partnumber" placeholder="Part Number" value="${itemsForm.getPart_number()}" path="part_number" class="form-control"/>                  </div>
 ...
 <form:input id="desc" placeholder="Description" path="description" class="form-control"/>                   
                ...
                <button type="submit" class="btn btn-primary pull-center">Update Item</button>
	</div>
	</div>
	</div>
	</div>
