  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">List Components
        </li>
      </ol>
    </section>
	...
	<c:if test="${!empty componentlist}">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				<th>S.No</th>
				<th>CTI Part No</th>
				<th>CTI US Part No</th>
				<th>Type</th>
				<th>Manufacturer</th>
				<th>MFG Part Number</th>
				<th>MFG Description</th>
				<th>Package</th>
				<th>&nbsp;</th>
				<th>&nbsp;</th>
			</tr>
			...
			<c:forEach items="${componentlist}" var="componentDetail">
				<tr>
				<td><c:set var="sno" value = "${sno+1 }"/>
				<c:out value="${sno }"/></td>
					<td>${componentDetail.ctipartno}</td>
					<td>${componentDetail.ctiuspartno}</td>
					<td>${componentDetail.type}</td>
					<td>${componentDetail. manufacturer}</td>
					<td>${componentDetail.mfgpartno}</td>
					<td>${componentDetail.mfgdesc}</td>
					<td>${componentDetail.packages}</td>
					<td> <a href="${contextPath}/loadcomponent?component=${componentDetail.comp_ID}"><i class="fa fa-refresh"></i></a></td>
					<td><a href="${contextPath}/deletecomponent?component=${componentDetail.comp_ID}"><i class="fa fa-trash-o"></i></a></td>
				</tr>
			</c:forEach>
                </tbody>
