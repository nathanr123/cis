  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href = "${contextPath}/listpurchaseitemdetail">List Purchase Item</a>
        </li>
        <li class="active">Update Purchase Item
        </li>
      </ol>
    </section>
...
<script src="resources/dist/js/demo.js"></script>
	...
	<div align="center">
		<form:form action="updatepurchaseitemdetail" method="post"
            ...
            <!-- form start -->
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                 <form:input path="purchasenumber" class="form-control" value="${purchaseitemdetailForm.getPurchasenumber()}"/>
              ...
              <div class="box-footer">
                ...
                <button type="submit" class="btn btn-primary pull-center">Update Purchase Item</button>
              </div>
